...
function  bannerEffect(){
   ...
   //定义一个函数，实现轮播图下面小白点自动功能
var　setIndicator=function(index){
    var indcators=banner.querySelector("ul:last-of-type").querySelectorAll("li");
    for(var i=0;i<indcators.length;i++){
        indcators[i].classList.remove("active");
    }
    indcators[index-1].classList.add("active");
}
    var timerId;
    /*5.实现自动轮播*/
