...
//准备sql语句
// $sql = "select p.title,p.content,p.created,p.views,p.likes,p.feature,c.`name`,u.nickname from posts p
// left join categories c on c.id = p.category_id
// left join users u on u.id = p.user_id
// where p.category_id != 1
// order by p.created DESC
// LIMIT 5;";
$sql = "select p.title,p.id,p.content,p.created,p.views,p.likes,p.feature,c.`name`,u.nickname,
        ...
        <div class="entry">
          ...
          <div class="main">
            ...
            <a href="javascript:;" class="thumb">
              <img src="<?php echo $value['feature'] ?>">
            </a>
          </div>
        </div>
        <?php endforeach; ?>
